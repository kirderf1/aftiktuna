mod ui {
    use aftiktuna::asset::location::{AreaData, SymbolMap};
    use aftiktuna::core::area::BackgroundId;
    use aftiktuna::core::{BlockType, Tag};
    ...
    fn area_view_ui(
        ...
        ui.separator();
        global_symbols_display(ui, &assets.base_symbols, &area.symbols);
    }
...
use aftiktuna_editor_three_d::editors::symbols::SymbolEditData;
